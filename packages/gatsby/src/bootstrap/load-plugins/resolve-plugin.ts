...
/**
 * Since `resolvePlugin` is used in Joi and Joi does not support
 * async in custom extensions, wrap this for now and export for use in
 * other modules in this directory.
 *
 * @see {@link https://github.com/sideway/joi/issues/2327}
 *
 * TODO - Refactor to use proper async fs apis for this
 */
